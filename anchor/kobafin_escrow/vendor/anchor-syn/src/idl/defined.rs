    ...
    match ty {
        ...
        syn::Type::Path(path) => {
            ...
            // Handle type aliases and external types
            {
                ...
                // Avoid proc_macro::Span::local_file (unstable on some toolchains).
                // We only need this for optional type-alias resolution; falling back
                // to an empty path is safe for IDL generation in our use case.
